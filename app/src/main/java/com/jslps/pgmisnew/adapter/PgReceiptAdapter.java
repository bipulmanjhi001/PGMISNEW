...
import com.jslps.pgmisnew.PgReceiptActivity;
...
public class PgReceiptAdapter extends RecyclerView.Adapter<PgReceiptAdapter.MyViewHolder> {



    private List<PgReceiptTranstbl> list;
    private Context context;
    private PgReceiptPresenter presenter;
    ...
    public PgReceiptAdapter(Context context, List<PgReceiptTranstbl> itemList, PgReceiptPresenter presenter) {
    ...
    public void onBindViewHolder(@NotNull MyViewHolder holder, int position) {
        PgReceiptTranstbl item = list.get(position);
    ...
    private void alert(String title,String message,PgReceiptTranstbl item){
        ...
        alert.show((PgReceiptActivity)context);
    }
