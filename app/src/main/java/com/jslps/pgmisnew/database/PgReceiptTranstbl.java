...
public class PgReceiptTranstbl extends SugarRecord {
    ...
    public PgReceiptTranstbl(String uuid, String budgetcode, String headname, String date, String amount, String remark, String pgcode, String createdby, String createdid, String isexported) {
        this.uuid = uuid;
